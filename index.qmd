...
4.  Between `col_wise_scan` and `row_wise_scan`, which function do you
    ...
    that might play a role in the 'col_wise_scan' being quicker than the 
    'row_wise_scan'. 
...
The col_wise_scan function took longer to run than the
row_wise_scan function. 
...
matrices, I conclude that the row_wise_scan is faster than the col_wise_scan.
