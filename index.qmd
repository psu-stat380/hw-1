---
title: "Homework 1"
author: "[Varun Bhatnagar]{style='background-color: yellow;'}"
toc: true
...
```{R}
# I expect both runtimes to be about the same. We aren't using any vectorization
```
...
```{R}
# Column sometimes performs better than row but both are about the same
```
