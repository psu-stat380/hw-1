...
```{R}
# using the sort function and specifying 'decreasing' as 'FALSE' to sort in ascending order
...
I am expecting col_wise_scan to take shorter to run because R programming stores data in sequential columns.
...
The row_wise_scan took longer to run.
...
I can conclude that 'row_wise_scan' takes longer to run.
