...
```{R}
#returns true if the number is greater than 0, and false if the number is less than 0
...
```{R}
#returns false for values less than 0, and true for values greater than 0
scan <- (M > 0)
